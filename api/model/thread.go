...
type Thread struct {
	...
	ThreadPicture string    `json:"threadPicture"`
...
type ThreadModelFactory interface {
	CreateThread(threadNo int, topicNo int, threadTitle, threadPicture, threadDesc string, createDate time.Time, banStatus bool, postList []Post) *Thread
}
...
func (factory *ConcreteThreadModelFactory) CreateThread(threadNo int, topicNo int, threadTitle, threadPicture, threadDesc string, createDate time.Time, banStatus bool, postList []Post) *Thread {
	return &Thread{
		ThreadNo:      threadNo,
		TopicNo:       topicNo,
